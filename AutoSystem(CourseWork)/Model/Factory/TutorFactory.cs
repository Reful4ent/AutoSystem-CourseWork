...
{
    internal class TutorFactory : MyRoleFactory
    {
        ...
        public TutorFactory(IChangeCourse changeCourse, IChangeTest changeTest, IChangeQuestion changeQuestion, IChangeUserRole changeUserRole, IDeleteUser deleteUser)
        {
        ...
        {
            Tutor member = new(_changeCourse, _changeTest, _changeQuestion, _changeUserRole, _deleteUser);
            return member;
        }
    }
}
