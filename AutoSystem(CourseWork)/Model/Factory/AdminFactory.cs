...
{
    internal class AdminFactory : MyRoleFactory
    {
        ...
        public AdminFactory(IChangeCourse changeCourse, IChangeTest changeTest, IChangeQuestion changeQuestion, IChangeUserRole changeUserRole, IDeleteUser deleteUser)
        {
        ...
        {
            Admin member = new(_changeCourse, _changeTest, _changeQuestion, _changeUserRole, _deleteUser);
            return member;
        }
    }
}
