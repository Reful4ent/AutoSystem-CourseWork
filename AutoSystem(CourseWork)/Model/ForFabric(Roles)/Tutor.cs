...
{
    public class Tutor : IChooseRole
    {
        ...
        public Tutor(IAnswerQuestion answerQuestion, IChangeUserCourse changeUserCourse, IChangeCourse changeCourse, IChangeTest changeTest, IChangeQuestion changeQuestion, IChangeAnswer changeAnswer, IChangeUserRole changeUserRole, IDeleteUser deleteUser)
        {
