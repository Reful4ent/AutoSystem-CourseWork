...
namespace AutoSystem_CourseWork_.Model.ForFabric_Roles_
{
    public class Admin : IChooseRole
    {
        ...
        public Admin(IAnswerQuestion answerQuestion, IChangeUserCourse changeUserCourse, IChangeCourse changeCourse, IChangeTest changeTest, IChangeQuestion changeQuestion, IChangeAnswer changeAnswer, IChangeUserRole changeUserRole, IDeleteUser deleteUser)
        {
