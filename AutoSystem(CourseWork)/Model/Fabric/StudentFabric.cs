...
{
    internal class StudentFabric : MyRoleFabric
    {
        ...
        public StudentFabric(IAnswerQuestion answerQuestion, IChangeUserCourse changeUserCourse, IChangeCourse changeCourse, IChangeTest changeTest, IChangeQuestion changeQuestion, IChangeAnswer changeAnswer, IChangeUserRole changeUserRole, IDeleteUser deleteUser)
        {
        ...
        {
            Student member = new(_answerQuestion, _changeUserCourse, _changeCourse, _changeTest, _changeQuestion, _changeAnswer, _changeUserRole, _deleteUser);
            return member;
        }
    }
}
